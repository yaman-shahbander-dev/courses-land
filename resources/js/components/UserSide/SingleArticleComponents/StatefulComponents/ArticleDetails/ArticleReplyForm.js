...
const sendComment = (comment, ArticleID) => {
    if (comment.length === 0) {
        swal({
        ...
        axios.get('http://127.0.0.1:8000/api/makeArticleComment', {
            params : {
                articleID : ArticleID,
                userID : userID,
                comment : comment
            ...
            <form action="#">
                <div className="row">
                    <div className="col-xl-12">
                        ...
                        <button className="btn blue-bg" type="submit" onClick={() => sendComment(comment, props.ArticleID)}
                         style={{
                            background: 'orange',
                            color: 'white'
                         }}>send reply</button>
