...
const ShowCommentData = () => {
    ...
    useEffect(() => {
        axios.get('http://127.0.0.1:8000/api/getUserCommentVideo', {
            params: {
                userId: userID,
                userType: usertypeID,
            }
                    ...
                    <div className="row">
                        <div className="col-lg-12 col-md-6 col-sm-12">
                            ...
                            <div className="form-group">
                                ...
                                <Link to={`searchCommentVideo?value=${searchValue}`} className="btn btn-primary btn-icon right_icon_toggle_btn" type="button"><i className="zmdi zmdi-arrow-right"></i></Link>
                            </div>
                        </div>
                    </div>
                </div>
